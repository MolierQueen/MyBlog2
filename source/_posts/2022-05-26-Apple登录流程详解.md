...
---
## 1：背景
2019年苹果推出 苹果登录（Sign in with Apple）方式，要求2020年4月之后运行在iOS13及以上系统的APP如果使用第三方或社交登录服务（如 Facebook、谷歌、 Twitter、Linkedln或亚马逊等），必须向用户提供“以苹果账号登录”服务的选项。其中苹果的[审核细则4.8](https://tva1.sinaimg.cn/large/e6c9d24egy1h2fzjjwwuaj21640p444d.jpg)也明确的规定了这一点。

![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2lmep99kij21ns0rkaba.jpg)

<!-- more -->

<font color="#dd0000">不过需要注意的一点是腾讯系列的产品如果只是使用微信、QQ登录并不算第三方登录，所以可以添加AppleID登录方式。</font><br /> 

![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2fzjjwwuaj21640p444d.jpg)
...
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g28b5w8aj21960u0769.jpg)
...
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g335dozbj219o0kiwg6.jpg)
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g36gha89j216x0u0gnx.jpg)


##### **步骤二：更新profile**
对app的任何更改都会导致现有的profile文件失效，所以需要重新生成profile描述文件。
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g38wg6kij20ia08qmxk.jpg)
按照如下路径操作，点进已经`invalid`的描述文件并重新生成
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g3em4u2oj21fq0lc75x.jpg)

##### **步骤三：生成密钥文件**
进入如下界面点击`加号`进行生成
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g3hh2cz2j216m0ms406.jpg)

填完并勾选`Sigin with apple`后点击右侧的`Configure`进行配置，在配置页面选择需要开启苹果登录的app并保存，然后回到上一页并开始注册
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g3kyolw0j21m10u043i.jpg)
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g3ps0bfjj21v70u0td1.jpg)
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g3qw6gvmj22120s0dkq.jpg)

最终注册成功后会有KeyID、TeamID和可供下载的密钥文件
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g3umbtqzj21wg0s4gqg.jpg)

密钥文件格式为.p8实际是文本文件
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g3yn74llj212g0badht.jpg)
...
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h2g4un5dizj20ve0u0dip.jpg)
